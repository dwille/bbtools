...
# Load images
i0500_20 = imread(root + "500/rho2.0/f-rec-1D/img/volume-fraction.png")
i0500_33 = imread(root + "500/rho3.3/f-rec-1D/img/volume-fraction.png")
i0500_40 = imread(root + "500/rho4.0/f-rec-1D/img/volume-fraction.png")
i0500_50 = imread(root + "500/rho5.0/f-rec-1D/img/volume-fraction.png")

i1000_20 = imread(root + "1000/rho2.0/f-rec-1D/img/volume-fraction.png")
i1000_33 = imread(root + "1000/rho3.3/f-rec-1D/img/volume-fraction.png")
i1000_40 = imread(root + "1000/rho4.0/f-rec-1D/img/volume-fraction.png")
i1000_50 = imread(root + "1000/rho5.0/f-rec-1D/img/volume-fraction.png")

i1500_20 = imread(root + "1500/rho2.0/f-rec-1D/img/volume-fraction.png")
i1500_33 = imread(root + "1500/rho3.3/f-rec-1D/img/volume-fraction.png")
i1500_40 = imread(root + "1500/rho4.0/f-rec-1D/img/volume-fraction.png")

i2000_20 = imread(root + "2000/rho2.0/f-rec-1D/img/volume-fraction.png")
i2000_33 = imread(root + "2000/rho3.3/f-rec-1D/img/volume-fraction.png")
...
# SAVE
imgname = imgdir + "volume-fraction-all"
