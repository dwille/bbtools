...
for pp in range(4):
  for dd in range(4):
    i = 4*pp + dd
    rg_ax.semilogx(data[i].time,RoG[i].kurt, color=colors[pp], alpha=shades[dd])
...
for pp in range(4):
  for dd in range(4):
    i = 4*pp + dd
    v_ax.semilogx(data[i].time, EVar[i].kurt, color=colors[pp], 
      alpha=shades[dd])
...
for pp in range(4):
  for dd in range(4):
    i = 4*pp + dd
    s_ax.semilogx(data[i].time, Shape[i].kurt, color=colors[pp],
      alpha=shades[dd])
...
for pp in range(4):
  for dd in range(4):
    i = 4*pp + dd
    i_ax.semilogx(data[i].time, I1[i].kurt, color=colors[pp],
      alpha=shades[dd])
    i_ax.semilogx(data[i].time, I2[i].kurt, color=colors[pp],
      alpha=shades[dd])
    i_ax.semilogx(data[i].time, I3[i].kurt, color=colors[pp],
      alpha=shades[dd])
