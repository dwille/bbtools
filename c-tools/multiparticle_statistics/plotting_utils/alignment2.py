...
ts = "500"
te = "1000"
alignFile = root + "data-tetrads/align.dat"
...
g1s_Ax.plot(time, g1s1, 'ko-', linewidth=1.5)
g1s_Ax.plot(time, g1s2, 'bo-', linewidth=1.5)
g1s_Ax.plot(time, g1s3, 'ro-', linewidth=1.5)
...
g2s_Ax.plot(time, g2s1, 'ko-', linewidth=1.5)
g2s_Ax.plot(time, g2s2, 'bo-', linewidth=1.5)
g2s_Ax.plot(time, g2s3, 'ro-', linewidth=1.5)
...
g3s_Ax.plot(time, g3s1, 'ko-', linewidth=1.5)
g3s_Ax.plot(time, g3s2, 'bo-', linewidth=1.5)
g3s_Ax.plot(time, g3s3, 'ro-', linewidth=1.5)
...
gw_Ax.plot(time, wg1, 'ko-', linewidth=1.5)
gw_Ax.plot(time, wg2, 'bo-', linewidth=1.5)
gw_Ax.plot(time, wg3, 'ro-', linewidth=1.5)
...
sw_Ax.plot(time, ws1, 'ko-', linewidth=1.5)
sw_Ax.plot(time, ws2, 'bo-', linewidth=1.5)
sw_Ax.plot(time, ws3, 'ro-', linewidth=1.5)
...
gzAx.plot(time, g1z, 'ko-', linewidth=1.5)
gzAx.plot(time, g2z, 'bo-', linewidth=1.5)
gzAx.plot(time, g3z, 'ro-', linewidth=1.5)
...
szAx.plot(time, s1z, 'ko-', linewidth=1.5)
szAx.plot(time, s2z, 'bo-', linewidth=1.5)
szAx.plot(time, s3z, 'ro-', linewidth=1.5)
