...
for pp, part in enumerate(partList):
  for dd, dens in enumerate(densList):
    ...
    alignMean = root + caseDir + '/data-tetrads/align.mean'
    ...
    # MEAN
    g1_s1[stride].mean = np.zeros(np.size(tmpT))
    g2_s1[stride].mean = np.zeros(np.size(tmpT))
    g3_s1[stride].mean = np.zeros(np.size(tmpT))
    g1_s2[stride].mean = np.zeros(np.size(tmpT))
    g2_s2[stride].mean = np.zeros(np.size(tmpT))
    g3_s2[stride].mean = np.zeros(np.size(tmpT))
    g1_s3[stride].mean = np.zeros(np.size(tmpT))
    g2_s3[stride].mean = np.zeros(np.size(tmpT))
    g3_s3[stride].mean = np.zeros(np.size(tmpT))
    g1_z[stride].mean = np.zeros(np.size(tmpT))
    g2_z[stride].mean = np.zeros(np.size(tmpT))
    g3_z[stride].mean = np.zeros(np.size(tmpT))
    s1_z[stride].mean = np.zeros(np.size(tmpT))
    s2_z[stride].mean = np.zeros(np.size(tmpT))
    s3_z[stride].mean = np.zeros(np.size(tmpT))
    w_z[stride].mean = np.zeros(np.size(tmpT))
    w_g1[stride].mean = np.zeros(np.size(tmpT))
    w_g2[stride].mean = np.zeros(np.size(tmpT))
    w_g3[stride].mean = np.zeros(np.size(tmpT))
    w_s1[stride].mean = np.zeros(np.size(tmpT))
    w_s2[stride].mean = np.zeros(np.size(tmpT))
    w_s3[stride].mean = np.zeros(np.size(tmpT))

    g1_s1[stride].mean = np.genfromtxt(alignMean, skip_header=1, usecols=1)
    g2_s1[stride].mean = np.genfromtxt(alignMean, skip_header=1, usecols=2)
    g3_s1[stride].mean = np.genfromtxt(alignMean, skip_header=1, usecols=3)
    g1_s2[stride].mean = np.genfromtxt(alignMean, skip_header=1, usecols=4)
    g2_s2[stride].mean = np.genfromtxt(alignMean, skip_header=1, usecols=5)
    g3_s2[stride].mean = np.genfromtxt(alignMean, skip_header=1, usecols=6)
    g1_s3[stride].mean = np.genfromtxt(alignMean, skip_header=1, usecols=7)
    g2_s3[stride].mean = np.genfromtxt(alignMean, skip_header=1, usecols=8)
    g3_s3[stride].mean = np.genfromtxt(alignMean, skip_header=1, usecols=9)

    g1_z[stride].mean = np.genfromtxt(alignMean, skip_header=1, usecols=10)
    g2_z[stride].mean = np.genfromtxt(alignMean, skip_header=1, usecols=11)
    g3_z[stride].mean = np.genfromtxt(alignMean, skip_header=1, usecols=12)
    s1_z[stride].mean = np.genfromtxt(alignMean, skip_header=1, usecols=13)
    s2_z[stride].mean = np.genfromtxt(alignMean, skip_header=1, usecols=14)
    s3_z[stride].mean = np.genfromtxt(alignMean, skip_header=1, usecols=15)

    w_z[stride].mean = np.genfromtxt(alignMean, skip_header=1, usecols=16)

    w_g1[stride].mean = np.genfromtxt(alignMean, skip_header=1, usecols=17)
    w_g2[stride].mean = np.genfromtxt(alignMean, skip_header=1, usecols=18)
    w_g3[stride].mean = np.genfromtxt(alignMean, skip_header=1, usecols=19)
    w_s1[stride].mean = np.genfromtxt(alignMean, skip_header=1, usecols=20)
    w_s2[stride].mean = np.genfromtxt(alignMean, skip_header=1, usecols=21)
    w_s3[stride].mean = np.genfromtxt(alignMean, skip_header=1, usecols=22)
